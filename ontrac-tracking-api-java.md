OnTrac Tracking API - Java
================================
Use Java to track OnTrac shipments with OnTrac Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.ontrac;
    ...
    public class CreateOnTracTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("D10015939090075");
                createTrackingParams.setCourierCode("ontrac");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateOnTracTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("C12205259026558");
                createTrackingParams1.setCourierCode("ontrac");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("D10015659891795");
                createTrackingParams2.setCourierCode("ontrac");
...
Get status of the shipment:
    ...
    public class GetOnTracTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("C12205259026558,D10015659891795");
                trackingParams.setCourierCode("ontrac");
...
Update a tracking by ID:
    ...
    public class UpdateOnTracTrackingExample {
