OnTrac Tracking API - Python
================================
Use Python to track OnTrac shipments with OnTrac Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    try:
      params = [
        {'tracking_number': 'C12205259026558', 'courier_code': 'ontrac'},
        {'tracking_number': 'D10015659891795', 'courier_code': 'ontrac'}
      ]
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': 'D10015659891795,D10015939090075', 'courier_code': 'ontrac'}
