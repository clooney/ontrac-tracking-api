...
Create a tracking (Real-time tracking):
      ...
      begin
        params  = {"tracking_number" => "D10015939090075","courier_code"=>"ontrac"}
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "C12205259026558","courier_code"=>"ontrac"},{"tracking_number" => "D10015659891795","courier_code"=>"ontrac"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"tracking_numbers" => "C12205259026558","courier_code"=>"ontrac"}
      # params  = {"tracking_numbers" => "C12205259026558,D10015659891795","courier_code"=>"ontrac"}
...
Update a tracking by ID:
    ...
    begin
      ...
      id_string = '98d15bc9498de1b168d2c6c4ded37176'
